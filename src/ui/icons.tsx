...
const SVG_PROPS = {
  ...
  style: { verticalAlign: 'middle' } as React.CSSProperties,
};
...
export function IconArrowExchange() {
  return (
    <svg {...SVG_PROPS}>
      ...
      <path d="M17 8.5C17 5.5 7 5.5 7 8.5C7 12 17 12 17 15.5C17 18.5 7 18.5 7 15.5" />
    </svg>
  );
}
...
export function IconQuestionMark() {
  return (
    <svg {...SVG_PROPS}>
      <path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3v2.5" />

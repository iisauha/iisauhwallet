...
const FAQ_ITEMS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: 'They need your device unlock code and your app passcode. Keep both on and your data stays protected. "Pause protection" only when you are the sole user and want faster access.',
  },
  {

...
const SECTIONS: Section[] = [
  ...
  },
  {
    icon: <IconShield />,
    title: 'Security',
    tagline: 'End-to-end encrypted. Your data, your passcode.',
    items: [
      { label: 'End-to-end encrypted', detail: 'Your data is encrypted with your passcode before it ever leaves your device. The cloud only stores an encrypted blob that nobody can read without your passcode.' },
      { label: 'Passcode protected', detail: 'A 6-digit passcode encrypts everything. Get it wrong too many times and lockout kicks in.' },
      { label: 'Cloud sync', detail: 'Sign in with your email and your data syncs across all your devices automatically. Same email + same passcode = same data everywhere.' },
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Interest accrual', detail: 'Calculates HYSA interest using the daily balance method — the same way banks do it. Tracks deposits and withdrawals throughout the month so your interest estimate is accurate, not just a simple balance times rate.' },
  ...
  },
  {
    ...
    tagline: 'Synced, secured, and customizable.',
    hint: 'Tap your name or avatar at the top of the screen.',
    items: [
      { label: 'Profile', detail: 'Set your display name and photo.' },
      { label: 'Customization', detail: 'Themes, fonts, surface style, tab order. Make the app look exactly how you want it.' },
      { label: 'Cloud sync', detail: 'Your data syncs to the cloud automatically after every change. Sign in on any device with the same email and passcode to access it.' },
      { label: 'Cloud backups', detail: 'A snapshot of your data is saved once per day. Browse previous backups in Settings and restore any one with a tap.' },
